...
Open surfaces are preferred when a container does not add meaning. Do not create card soup, decorative pills, random accent colours or a different rounded box for every line of information.

Trust styling must reflect canonical truth. Publication, loading success or a green semantic colour does not by itself authorize a customer-facing verification promise.

Yellow remains a sparse signature, not a generic attention/highlight colour.
