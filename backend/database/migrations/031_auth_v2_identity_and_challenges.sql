...
--   4. Atomic verification with FOR UPDATE row-level locking.
--   5. Idempotent legacy phone backfill preserving truthful phone_verified_at.
--   6. Profile emails are NOT auto-backfilled or auto-linked.
--   7. users.phone_number NOT NULL is preserved; owners.id = users.id is preserved.
-- ============================================================================
