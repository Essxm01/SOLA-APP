...
export async function runAdminFoundationSuite() {
    const results = [];
    ...
    try {
        const mockProp = { status: 'PENDING_REVIEW', verificationStatus: 'UNVERIFIED' };
    ...
    try {
        const mockDispute = { id: 'disp1', status: 'ESCALATED_TO_ADMIN' };
    ...
    try {
        const mockDispute = { id: 'disp1', status: 'RESOLVED' };
