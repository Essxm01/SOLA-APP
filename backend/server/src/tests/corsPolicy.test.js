...
export async function runCorsPolicySuite() {
    const results = [];
    ...
    const makeHttpRequest = (method, path, headers) => {
    ...
    try {
        ...
        const ownerPreflightPass = resOwnerPreflight.statusCode === 204 &&
        ...
        const adminPreflightPass = resAdminPreflight.statusCode === 204 &&
        ...
        const evilPreflightPass = resEvilPreflight.statusCode === 403 &&
