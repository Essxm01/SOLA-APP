...
import { DisputeDomainController, AdminDomainController } from '../controllers/domainControllers';
...
export async function runCustomerMessagingDisputesSuite(): Promise<{
  total: number;
  passed: number;
  failed: number;
  results: TestResult[];
