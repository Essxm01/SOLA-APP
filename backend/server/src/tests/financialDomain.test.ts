...
import type { Property, Booking, Dispute } from '@types';
import type { TestResult } from './authSecurity.test';

export async function runFinancialDomainSuite(): Promise<{ total: number; passed: number; failed: number; results: TestResult[] }> {
