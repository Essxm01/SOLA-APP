...
export async function runMultiPartyIntegrationSuite() {
    const results = [];
    ...
    try {
        ...
        const seesPending = Array.isArray(bookings) && bookings.some((b) => b.status === 'PENDING_OWNER_APPROVAL');
    ...
    try {
        ...
        const isAccurate = breakdown.totalBookingValueInCents === 500000 &&
    ...
    // =========================================================================
    try {
        const mockConfirmed = { status: 'CONFIRMED', confirmedAt: '2026-08-15T00:00:00Z' };
    ...
    // =========================================================================
    try {
        const mockPending = { id: 'bk_001', status: 'PENDING_OWNER_APPROVAL' };
