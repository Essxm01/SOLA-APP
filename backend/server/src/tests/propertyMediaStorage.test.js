...
export async function runPropertyMediaStorageSuite() {
    ...
    try {
        ...
        const commitBody = resCommit.body;
        ...
        const fakeIntentUrl = resFakeIntent.body.data?.uploadUrl?.replace('http://localhost:4000', baseUrl);
        ...
        const isDeleted = resDelete.statusCode === 200 && resDelete.body.data?.deleted === true;
