      ...
      >
        ...
        <div className="flex-1">
          ...
          <header className="flex items-center gap-2 pb-6 pt-1">
            <img src="/favicon.svg" alt="KONFRM" className="h-6 w-6" aria-hidden="true" />
            <span className="text-xs font-black tracking-tight text-slate-700">صولا</span>
          </header>
          ...
          {/* Payment Reassurance */}
          <div className="mt-4 rounded-xl border border-slate-200/80 bg-slate-50/70 p-3.5 text-xs font-bold text-slate-800 sm:text-sm">
              ...
              <dl className="divide-y divide-slate-100 text-xs sm:text-sm">
                {cleanTitle && (
                  <div className="flex items-baseline justify-between gap-4 pb-2.5">
                    <dt className="shrink-0 font-bold text-slate-500">الوحدة</dt>
                    <dd className="truncate text-left font-extrabold text-slate-900">
                      {cleanTitle}
                    </dd>
                  </div>
                )}
                ...
                <div className="flex items-baseline justify-between gap-4 py-2.5">
                  ...
                  <dd className="text-left text-sm font-black text-slate-950 sm:text-base">
                ...
                <div className="flex items-baseline justify-between gap-4 pt-2.5 text-[#0059FF]">
                  ...
                  <dd className="text-left text-sm font-black sm:text-base">
