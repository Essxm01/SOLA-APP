...
| [codex/KONFRM_FOUNDER_DEFERRED_REGISTRY.md](./codex/KONFRM_FOUNDER_DEFERRED_REGISTRY.md) | Returning to anything the Founder explicitly postponed, checking deferred Auth/Profile/Screen decisions, or recording a new Founder deferral | Active work with no deferred dependency |
