...
| Supabase Storage | Canonical property-media upload/storage | `OBJECT_STORAGE_PROVIDER=supabase`, `SUPABASE_STORAGE_BUCKET`, optional `STORAGE_CDN_HOST`; provider code is `backend/server/src/services/storageProvider.ts`. |
