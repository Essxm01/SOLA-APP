...
| --- | --- | --- | --- | --- | --- | --- |
| Identity and session | P1.2, P2.2, P14.3 | Implemented but unverified | Customer auth behavior exists | Canonical Owner boundary and explicit registration/KYC code exist | Validated Admin entry code exists | JWT/session/role architecture and migrations exist | Cross-role auth expiry/error and live revision verification |
