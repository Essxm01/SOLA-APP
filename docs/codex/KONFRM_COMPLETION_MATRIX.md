...
| DB baseline/RLS | P1.1, P14.1 | Inventory complete; remediation prerequisite | N/A | N/A | N/A | P1.1 read-only table/constraint/RLS/grant/storage report recorded | Public SECURITY DEFINER grants and no-policy model require P14.1 before P1.2 |
