...
| --- | --- | --- | --- | --- | --- | --- |
| Identity and session | P0.2, P1.2, P2.2, P14.3 | Implemented—local verification | Candidate-token bootstrap/public/protected behavior tested | Canonical Owner gate, clear-on-logout, and failure distinction tested | Validated session/shell truthfulness tested | Signed JWT role gates and representative subject authority tested | Full RLS/production-auth and deployed-revision assurance |
...
| DB baseline/RLS | P1.1, P14.1 | Blocked | Migrations 008–020 retained | Full schema/RLS inventory/read-only confirmation | All persistence | Verify before schema/security claims |
