...
| Property | P1.3, P3.1–P3.3 | Implemented but unverified | Discovery/property detail code exists | Wizard, local/canonical draft and media code exist | Review queue code exists | P1.3 property/media persistence was merged at `fb38414…`; Storage/schema/live cross-app acceptance remains unverified | Verify current cross-app publication/rejection/media behavior |
